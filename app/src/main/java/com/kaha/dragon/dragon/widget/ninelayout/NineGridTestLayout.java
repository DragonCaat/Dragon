...
public class NineGridTestLayout extends NineGridLayout {
    ...
    @Override
    protected void displayImage(int position, RatioImageView imageView, int url) {
        if (context != null) {
    ...
    @Override
    protected void onClickImage(int imageIndex, int url, List<Integer> urlList, ImageView imageView) {
