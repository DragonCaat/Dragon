...
public abstract class NineGridLayout extends ViewGroup {
    ...
    private RatioImageView createImageView(final int i, final int url) {
     ...
     * 放制图片的位置
     *
     * @param imageView 自定义的图片
     * @param url       图片的地址
     */
    private void layoutImageView(RatioImageView imageView, int i, int url) {
    ...
    private int getListSize(List<Integer> list) {
    ...
    protected abstract void displayImage(int position, RatioImageView imageView, int url);

    protected abstract void onClickImage(int position, int url, List<Integer> urlList, ImageView imageView);
}
